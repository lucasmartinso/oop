...
function onAddTask(boardId, newTaskName) {
  ...
  const task = new Tasks(lastTaskId + 1,newTaskName,false)
...
const tasks = [
  new Tasks(1,"tarefa 1",false),
  new Tasks(2,"tarefa 2",false),
  new Tasks(3,"tarefa 3",false),
  new Tasks(4,"tarefa 4",false),
  new Tasks(5,"tarefa 5",true)
];
